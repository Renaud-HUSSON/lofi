...
const HomeText = () => {
  return <section className="lg:w-1/2 self-start lg:self-center mb-5">
    ...
    <Link className="transition-colors duration-500 inline-block xl:text-3xl lg:text-2xl text-base dark:bg-white bg-black p-4 sm:px-6 sm:py-4 dark:text-black text-white" to="/collection">SEE THE COLLECTION</Link>
  </section>
}
