...
const HomeText = () => {
  return <section className="lg:w-1/2 self-start lg:self-center mb-5">
    ...
    <Link href="/collection"><a className="transition-colors font-semibold duration-500 inline-block xl:text-3xl lg:text-2xl text-base dark:bg-white bg-black p-4 sm:px-6 sm:py-4 dark:text-black text-white">SEE THE COLLECTION</a></Link>
  </section>
}
